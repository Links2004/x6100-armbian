...
Main() {
	...
	apt-get install -y quisk tigervnc-standalone-server tigervnc-viewer socat ser2net gdb-minimal gdbserver strace e2fsprogs xfce4-battery-plugin xfce4-power-manager xfce4-systemload-plugin libqt5sql5-sqlite xinetd gpiod
